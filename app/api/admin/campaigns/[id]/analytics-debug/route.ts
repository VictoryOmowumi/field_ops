...
import { getCampaignMetricsDiagnostics } from "@/lib/campaign/intelligence";
...
export async function GET(request: NextRequest, context: RouteContext) {
  ...
  const diagnostics = await getCampaignMetricsDiagnostics(supabase, membership.organizationId, id);
